...
| 進行中 | [TKT-018](TKT-018-web-japanese-support.md) | Web 日本語対応 | - | `M10` `M4` `M5` `M8` | `TKT-010` `TKT-011` | `TKT-007` |
| 未着手 | [TKT-019](TKT-019-web-japanese-dictionary-bootstrap.md) | Web 日本語 dictionary bootstrap / runtime | `TKT-018` | `M10` `M5` | `TKT-010` `TKT-011` | `TKT-020` `TKT-021` |
...
- `TKT-007` は release 完了条件の最終集約チケットで、他チケットの結果を取り込みます。Web については `TKT-002` の umbrella 状態だけでなく、`TKT-011` の smoke / README 反映完了と `TKT-018` 系の日本語対応完了も依存に含めます。
