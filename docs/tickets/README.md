...
| 進行中 | [TKT-012](TKT-012-web-github-pages-deploy.md) | Web GitHub Pages deploy / public demo | - | `M9` `M7` | `TKT-011` | `TKT-013` `TKT-014` `TKT-015` `TKT-016` |
...
| 未着手 | [TKT-014](m9-github-pages/TKT-014-github-pages-preset-public-entry.md) | GitHub Pages preset / public entry 整備 | `TKT-012` | `M9` `M7` | `TKT-013` | `TKT-015` `TKT-016` |
| 未着手 | [TKT-015](m9-github-pages/TKT-015-github-pages-deploy-workflow.md) | GitHub Pages deploy workflow 整備 | `TKT-012` | `M9` `M7` | `TKT-013` `TKT-014` | `TKT-016` |
| 未着手 | [TKT-016](m9-github-pages/TKT-016-github-pages-public-url-smoke.md) | GitHub Pages public URL smoke 整備 | `TKT-012` | `M9` `M7` | `TKT-014` `TKT-015` | - |
