...
|---|---|---|---|---|---|
| 進行中 | [TKT-001](TKT-001-multilingual-parity.md) | multilingual parity 拡張 | `M2` `M5` `M8` | - | `TKT-007` |
| 未着手 | [TKT-002](TKT-002-web-platform.md) | Web platform 対応 | `M7` `M4` `M5` `M8` | - | `TKT-007` |
