...
- 後続チケット: `TKT-015` `TKT-016` `TKT-017`
...
- `TKT-015` には、workflow がこのチケットで固定した artifact 構成とファイル名をそのまま publish するよう引き継ぐ。
- `TKT-016` には、public URL smoke がこのチケットで固定した `index.html` と minimal demo 導線を前提に設計されるよう引き継ぐ。
- `TKT-017` には、公開手順と known limitations がこのチケットの preset / artifact 契約と一致するよう引き継ぐ。
