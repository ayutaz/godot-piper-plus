...
| 未着手 | `TKT-014` | `GP1` | Pages 向け preset / public entry 整備 | `TKT-013` | - |
| 未着手 | `TKT-015` | `GP2` | Pages deploy workflow 整備 | `TKT-013` `TKT-014` | - |
| 未着手 | `TKT-016` | `GP3` | public URL smoke 整備 | `TKT-014` `TKT-015` | - |
