...
| 進行中 | M9 GitHub Pages Public Demo / Deploy | post-preview Web public demo / GitHub Pages deployment | [TKT-012](./tickets/TKT-012-web-github-pages-deploy.md) [TKT-013](./tickets/m9-github-pages/TKT-013-github-pages-scope-asset-policy.md) [TKT-014](./tickets/m9-github-pages/TKT-014-github-pages-preset-public-entry.md) [TKT-015](./tickets/m9-github-pages/TKT-015-github-pages-deploy-workflow.md) | `M7` 完了後の follow-up。`GP0` から `GP2` の ticket 分解まで完了し、scope、preset/public entry、Pages deploy workflow の責務を個別化しています |
...
- 状態: `進行中`
- 依存: `M7`
- 関連チケット: [TKT-012 Web GitHub Pages deploy / public demo](./tickets/TKT-012-web-github-pages-deploy.md) [TKT-013 GitHub Pages scope / asset policy 固定](./tickets/m9-github-pages/TKT-013-github-pages-scope-asset-policy.md) [TKT-014 GitHub Pages preset / public entry 整備](./tickets/m9-github-pages/TKT-014-github-pages-preset-public-entry.md) [TKT-015 GitHub Pages deploy workflow 整備](./tickets/m9-github-pages/TKT-015-github-pages-deploy-workflow.md)
- 現状: GitHub Pages 対応の前提整理は [docs/web-github-pages-plan.md](./web-github-pages-plan.md) に反映済みです。`docs/tickets/m9-github-pages/` で `GP0` から `GP2` を個別チケット化し、public demo scope、model 配布方針、preset / public entry、Pages deploy workflow の責務分割を先に固定しています。Pages 向け preset、`index.html` export、deploy workflow、public URL smoke は未実装です。
- 実装スコープ:
  - `no-threads`
  - `CPU-only`
