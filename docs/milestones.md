...
- Web preview support 自体は完了済みです。GitHub Pages 上で動く public demo / deploy も独立マイルストーン [`M9 GitHub Pages Public Demo / Deploy`](#m9) として完了しており、技術整理は [`docs/web-github-pages-plan.md`](./web-github-pages-plan.md) にまとめています。
